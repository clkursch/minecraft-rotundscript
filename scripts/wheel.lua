...
local slugcatUpperBody = models.models.slugcat.FullBody.UpperBody
local slugcatLowerBody = models.models.slugcat.FullBody.LowerBody
...
function events.tick()
	...
	local color = helmet == "minecraft:leather_helmet" and vectors.hexToRGB("#8f6f5e")
		or (helmet == "minecraft:chainmail_helmet" or helmet == "minecraft:iron_helmet") and vectors.hexToRGB("#707070")
	...
	local color =  chestplate == "minecraft:leather_chestplate" and vectors.hexToRGB("#8f6f5e")
		or (chestplate == "minecraft:chainmail_chestplate" or chestplate == "minecraft:iron_chestplate") and vectors.hexToRGB("#707070") --dcdcdc
	...
	local color =  leggings == "minecraft:leather_leggings" and vectors.hexToRGB("#8f6f5e")
		or (leggings == "minecraft:chainmail_leggings" or leggings == "minecraft:iron_leggings") and vectors.hexToRGB("#707070")
	...
	local color =  boots == "minecraft:leather_boots" and vectors.hexToRGB("#8f6f5e")
		or (boots == "minecraft:chainmail_boots" or boots == "minecraft:iron_boots") and vectors.hexToRGB("#707070")
